    ...
    <nav className="w-full navbar">
      <div className="container px-8 py-4 flex items-center justify-between border-2  ">
        ...
        <div className="gap-2 mx-5 hidden md:flex">
          <Link to="/signin">
            <button className="hover:bg-btnColor hover:border-btnColor hover:text-white border-2 border-btnColor px-8 py-1 text-btnColor rounded">
              Log in
            </button>
          </Link>
          <Link to="/register" className="">
            <button className="bg-btnColor hover:bg-white hover:text-teal-700 px-8 py-1 border-btnColor border-2 text-white rounded">
              Sign up
            </button>
          </Link>
          <div></div>
