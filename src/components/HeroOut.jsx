    ...
    <section>
      <div className="flex md:flex-row flex-col items-center m-auto p-12 ">
        <div className="container flex-1 flex justify-center items-start flex-col xl:px-0 sm:px-16">
          ...
          <div className="my-8 gap-6 flex-col md:flex-row  sm:items-start items-center">
            <Link to="/blog">
              <button className="bg-btnColor border-2 my-4 px-20 py-3 md:mx-2   border-btnColor text-white rounded">
                Our latest news..
              </button>
            </Link>
            <Link to="/subject">
              <button className="border-2 my-4   border-btnColor md:mx-2 px-20 py-3 text-btnColor rounded">
                Search courses
              </button>
            </Link>
          </div>
